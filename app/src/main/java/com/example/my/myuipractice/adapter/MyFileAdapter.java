package com.example.my.myuipractice.adapter;
...
import com.example.my.myuipractice.R;
...
public class MyFileAdapter extends BaseAdapter {
     ...
     * @param pa
     */
    public MyFileAdapter(Context context, ArrayList<String> na, ArrayList<String> pa) {
        names = na;
        paths = pa;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView){
            ...
            holder.image = (ImageView)convertView.findViewById(R.id.iv_file);
